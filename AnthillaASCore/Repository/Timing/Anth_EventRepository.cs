...
namespace AnthillaASCore.Repositories
{
    public class Anth_EventRepository
    {
        ...
        public Anth_EventModel Create(string guid, string alias, string type, string det, string date, string s, string e, string tags)
        {
        ...
        public Anth_EventModel Edit(string id, string alias, string type, string det, string date, string s, string e, string tags)
        {
        ...
        public Anth_Dump GetByDateHour(string date, string hour)
        {
