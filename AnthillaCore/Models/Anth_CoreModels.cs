...
namespace AnthillaCore.Models {
    ...
    public class Anth_Object {
        ...
        public bool IsLicense { get { return f; } set { f = value; } }
    ...
    public class Anth_Dump : Anth_Object {
        ...
        public bool AnthillaInsider { get; set; }
        ...
        public string AnthillaProjectCode { get; set; }

        public string AnthillaCompanyLeaderId { get; set; }
        ...
        public string AnthillaTrackAlias { get; set; }

        public string AnthillaFileOwner { get; set; }

        public string AnthillaFileContext { get; set; }

        public string AnthillaFilePackageId { get; set; }

        public List<string> AnthillaFileList { get; set; }

        public string AnthillaVersion { get; set; }

        public int AnthillaVersionInt { get; set; }

        public string AnthillaDescription { get; set; }

        public string AnthillaMessage { get; set; }

        public string AnthillaPackageKey { get; set; }

        public bool AnthillaPackageIsEmpty { get; set; }
        ...
        public long AnthillaMailMessageUId { get; set; }
        ...
        public bool AnthillaMailboxHasChild { get; set; }

        public List<string> AnthillaMailboxSubfolders { get; set; }
        ...
        public string AnthillaVerificationUrl { get; set; }

        public DateTime AnthillaVerificationUrlCreated { get; set; }

        public int AnthillaVerificationUrlVal { get; set; }
        ...
        public string AnthillaLicenseGuid { get; set; }

        public string AnthillaLicenseTitle { get; set; }

        public string AnthillaLicenseText { get; set; }

        #endregion License Attributes
    }
}