...
namespace AnthillaFirewall {
    ...
    internal static class Program {
        ...
        private static void Main(string[] args) {
            ...
            Console.Title = "AnthillaFirewall";
            Thread.Sleep(1000);

            Console.WriteLine(ConsoleTime.GetTime(DateTime.Now) + "loading application...");

            FirewallConfig.WriteDefaults();
            Console.WriteLine(ConsoleTime.GetTime(DateTime.Now) + "setting core firewall configuration...");
            ...
            string uri = FirewallConfig.GetAnthillaFirewallUri();
            Console.WriteLine(ConsoleTime.GetTime(DateTime.Now) + "initializing anthillafirewall");
    ...
    public class Database {
        ...
        public static void Start() {
            ...
            string root = FirewallConfig.GetAnthillaDb();
            databases = new string[] { root };

            string raid = FirewallConfig.GetAnthillaDbRaid();
            if (raid != null && raid != "") {
